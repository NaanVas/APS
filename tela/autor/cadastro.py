...
class TelaCadastroAutor(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Cadastrar Autor", font=("Montserrat", 16, "bold"), fg="#482E1D", bg="#F0DAAE")
        ...
        tk.Label(self.frame_central, text="Nacionalidade:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=2, column=0, pady=5, sticky='e')
