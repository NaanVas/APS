...
class TelaBuscarFuncionario(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Buscar Funcionário", font=("Montserrat", 18, "bold"), fg="#482E1D", bg="#F0DAAE")
        label_titulo.grid(row=0, column=0, columnspan=2, pady=20)

        tk.Label(self.frame_central, text="CPF:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=0, column=0, pady=5, sticky='e')
    ...
    def mostrar_dados_funcionario(self, funcionario):
        ...
        tk.Label(self.frame_central, text=info_funcionario, font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=1, column=0, columnspan=2, pady=10)
