...
class TelaCadastroFuncionario(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Cadastrar Funcionário", font=("Montserrat", 16, "bold"), fg="#482E1D", bg="#F0DAAE")
        ...
        tk.Label(self.frame_central, text="Data de Nascimento:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=3, column=0, pady=5, sticky='e')
        self.entry_data_nascimento = tk.Entry(self.frame_central)
        self.entry_data_nascimento.grid(row=3, column=1, pady=5)

        tk.Label(self.frame_central, text="Salário:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=4, column=0, pady=5, sticky='e')
        self.entry_salario = tk.Entry(self.frame_central)
        self.entry_salario.grid(row=4, column=1, pady=5)

        tk.Label(self.frame_central, text="Senha:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=5, column=0, pady=5, sticky='e')
