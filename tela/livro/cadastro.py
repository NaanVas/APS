...
class TelaCadastroLivro(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Cadastrar Livro", font=("Montserrat", 16, "bold"), fg="#482E1D", bg="#F0DAAE")
        label_titulo.grid(row=0, column=0, columnspan=2, pady=20)

        tk.Label(self.frame_central, text="Título:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=1, column=0, pady=5, sticky='e')
        self.entry_titulo = tk.Entry(self.frame_central)
        self.entry_titulo.grid(row=1, column=1, pady=5)

        tk.Label(self.frame_central, text="Autor:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=2, column=0, pady=5, sticky='e')
        self.entry_autor = tk.Entry(self.frame_central)
        self.entry_autor.grid(row=2, column=1, pady=5)

        tk.Label(self.frame_central, text="Editora:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=3, column=0, pady=5, sticky='e')
        self.entry_editora = tk.Entry(self.frame_central)
        self.entry_editora.grid(row=3, column=1, pady=5)

        tk.Label(self.frame_central, text="Ano de Publicação:", font=("Montserrat", 10), fg="#482E1D", bg="#F0DAAE").grid(row=4, column=0, pady=5, sticky='e')
