...
class TelaExcluirUsuario(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Excluir Usuário", font=("Montserrat", 18, "bold"), fg="#482E1D", bg="#F0DAAE")
        ...
        self.botao_salvar = ttk.Button(self.frame_central, text="Salvar", style="Estilo.TButton", command=self.excluir_usuario)
