...
class TelaBuscarUsuario(TelaPadrao):
    def __init__(self, root, voltar_callback):
        ...
        label_titulo = tk.Label(self.frame_central, text="Buscar Usuário", font=("Montserrat", 18, "bold"), fg="#893F04", bg="#E5E0D8")
    ...
    def exibir_resultado_busca(self, usuario):
        resultado = f"CPF: {usuario.get_cpf()}\n" \
                    ...
                    f"Data de Nascimento: {usuario.get_data_nascimento()}\n"
